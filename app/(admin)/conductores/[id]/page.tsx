...
type NavItem = {
  ...
  icon: ReactNode
  badge?: number
  roles: AdminRole[]   // qué roles pueden ver este item
}

type NavGroup = {
  group: string
  items: NavItem[]
  roles: AdminRole[]   // si ningún item del grupo es visible, el grupo se oculta
}

// Roles que tienen acceso a todo
...
export default function Sidebar() {
  ...
  // Filtra items y grupos según el rol actual
