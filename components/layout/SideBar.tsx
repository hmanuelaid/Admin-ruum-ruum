...
const ALL = ['super_admin', 'finanzas', 'comercial', 'operaciones', 'validador']
const OPS = ['operaciones', 'super_admin']
const FIN = ['finanzas', 'super_admin']
const COM = ['comercial', 'super_admin']
const VAL = ['validador', 'super_admin']
...
export default function Sidebar() {
  ...
  // NAV definido dentro del componente → siempre en cliente
  const NAV: NavGroup[] = [
    {
    ...
    {
      group: 'Sistema', roles: ['super_admin'],
      items: [
